...
import successAnimation from "./Congratulations.json";
export const Last = () => {
  return (
      ...
      <div className="w-120 min-h-163.75 bg-white rounded-lg p-8 shadow-xl relative">
        <div className="space-y-2">
          ...
          >
            ...
            <defs>
              <pattern
                ...
                height="1"
              >
                <use xlinkHref="#image0_1_265" transform="scale(0.00195312)" />
              </pattern>
              <image
                id="image0_1_265"
                width="512"
          ...
          <Lottie
            ...
            loop={false}
            className="w-103.75 h-138.25 flex items-center justify-center overflow-hidden absolute"
          />
          <img
            className="w-112.5 h-125 object-cover rounded-xl"
